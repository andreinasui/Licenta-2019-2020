...
Pentru o clasificare cât mai reușită, datele EEG înregistrate trebuie sa fie prelucrate înainte de a fi folosite ca intrare pentru rețeaua convoluțională. Astfel parte de preprocesare a datelor conține următorii pași:
\begin{enumerate}
	\item Filtrarea datelor
	\item 
\end{enumerate}
